...
verses_translations = {
  ...
  "my": [
    ...
    {"reference": "ရော ၈:၁၅", "text": "အကြောင်းမူကား၊ သင်တို့သည် တစ်ဖန် ကြောက်ရွံ့ခြင်းသို့ ရောက်စေမည့် ကျွန်ခံခြင်း သဘောရှိသော ဝိညာဉ်ကို မရကြ။ အဗ္ဗ၊ အဘဟု ခေါ်ဝေါ်စေသော သားအရာ၌ ခန့်ထားတော်မူခြင်း ဝိညာဉ်ကို ရကြပြီ။"},
...
def main():
    ...
    for filename, lang in files:
        ...
        # For Hebrew check both `iw` and `he`
        if f"identity-manifestation-mission-{lang}" in content or f"identity-manifestation-mission-iw" in content:
